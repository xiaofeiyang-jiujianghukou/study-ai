...
public class CommonAIManager {
    ...
    public ChatRespDTO chat(ChatReqDTO input, WebClient webClient) {
    ...
    public String generateResponse(String userMessage, WebClient webClient, CommonClientConfig commonClientConfig) {
        ...
        requestBody.put("model", commonClientConfig.getAPI_MODEL());
        requestBody.put("stream", false);
